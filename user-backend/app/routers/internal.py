...
from backend_shared.services.metaapi_sync import sync_accounts
from backend_shared.services.rebate_calculation import calculate_rebates
from backend_shared.services.copyfactory_sync import ensure_copytrading_deployed, stop_lapsed_subscriptions
