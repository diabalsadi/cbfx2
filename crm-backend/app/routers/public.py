...
from backend_shared.schemas.broker_placement import SECTIONS as PLACEMENT_SECTIONS
from backend_shared.models.ad_banner import AdBanner
from backend_shared.models.seo_meta import SeoMeta, SeoSettings
from backend_shared.schemas.seo_meta import SEO_ROUTES
...
from backend_shared.schemas.article import Article as ArticleSchema
from backend_shared.schemas.broker_offer import PublicBrokerOffer
from backend_shared.utils.geo import detect_region, extract_client_ip
from backend_shared.utils.translate import detect_locale, translate_fields
from backend_shared.utils.forum_stats import get_reply_count_lookup
from backend_shared.utils.cache import public_cache, PUBLIC_CACHE_TTL_SECONDS
from backend_shared.utils.broker_offer import referral_url
...
def get_broker_offer(broker_id: str, request: Request, db: Session = Depends(get_db)):
    ...
    return PublicBrokerOffer(
        ...
        regulations=broker.regulations or [],
