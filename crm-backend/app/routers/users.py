...
from backend_shared.schemas.user import (
    User as UserSchema,
    UserSelfUpdate,
    AdminUserCreate,
    AdminUserUpdate,
...
from backend_shared.utils.auth import get_current_user, get_password_hash, verify_password, generate_temp_password
from backend_shared.utils.mailer import (
