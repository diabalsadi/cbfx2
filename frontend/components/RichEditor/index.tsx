    ...
    <div className={styles.wrapper}>
      <div className={styles.toolbar}>
        ...
        <div className={styles.toolGroup}>
          ...
          <ToolbarButton active={editor.isActive('paragraph')} onClick={() => editor.chain().focus().setParagraph().run()} title="Paragraph">P</ToolbarButton>
        </div>
        <div className={styles.divider} />
        <div className={styles.toolGroup}>
        ...
        <div className={styles.divider} />
        <div className={styles.toolGroup}>
          <ToolbarButton active={editor.isActive('link')} onClick={addLink} title="Insert Link">🔗</ToolbarButton>
          <ToolbarButton active={false} onClick={addImage} title="Insert Image">🖼</ToolbarButton>
          <ToolbarButton active={false} onClick={addYoutube} title="Embed YouTube">▶</ToolbarButton>
        </div>
        <div className={styles.divider} />
        <div className={styles.toolGroup}>
          <ToolbarButton active={false} onClick={() => editor.chain().focus().undo().run()} title="Undo">↩</ToolbarButton>
          <ToolbarButton active={false} onClick={() => editor.chain().focus().redo().run()} title="Redo">↪</ToolbarButton>
        </div>
      </div>
