            ...
            <div className={styles.contactContainer}>
                ...
                <form action="" className={styles.contactForm}>
                    <div className={styles.inputGroup}>
                        ...
                        <input id="subject" type="text" placeholder='Enter the subject' required className={styles.input} />
                    </div>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <textarea name="" id="message" placeholder='Write your message here...' required className={styles.textarea}></textarea>
                    </div>
