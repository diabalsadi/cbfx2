    ...
    <div className={styles.container}>
      <div className={styles.headerRow}>
        <div>
          ...
          <p className={styles.subtitle}>Upload and manage performance reports.</p>
        </div>
      </div>
      ...
      >
        ...
        {files.length === 0 ? (
          <>
            <p className={styles.uploadText}>
              ...
              <span className={styles.browseLink} onClick={() => fileInputRef.current?.click()}>browse</span>
            </p>
          ...
          <div className={styles.fileList}>
            ...
            <button className={styles.clearBtn} onClick={clearFiles}>Remove and select another</button>
          </div>
        )}
        <input
          type="file"
        ...
        />
        {files.length > 0 && (
          <button className={styles.uploadBtn}>Upload {files.length} file{files.length > 1 ? 's' : ''}</button>
        )}
      </Card>
