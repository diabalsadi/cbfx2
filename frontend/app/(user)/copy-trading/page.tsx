...
const TRADERS = [
  { name: 'Alex Morgan',    initials: 'AM', country: '🇺🇸', followers: '12.4k', roi: '+184%', winRate: '73%', trades: 214, drawdown: '8.2%',  monthly: '+15.3%', color: '#f97316' },
  { name: 'Priya Shah',     initials: 'PS', country: '🇮🇳', followers: '9.1k',  roi: '+147%', winRate: '69%', trades: 189, drawdown: '6.7%',  monthly: '+12.2%', color: '#8b5cf6' },
  { name: 'Marco R.',       initials: 'MR', country: '🇮🇹', followers: '7.8k',  roi: '+121%', winRate: '66%', trades: 302, drawdown: '10.1%', monthly: '+10.1%', color: '#06b6d4' },
  { name: 'Yuki Tanaka',    initials: 'YT', country: '🇯🇵', followers: '6.2k',  roi: '+98%',  winRate: '71%', trades: 156, drawdown: '5.4%',  monthly: '+8.2%',  color: '#ec4899' },
  { name: 'Carlos Vega',    initials: 'CV', country: '🇲🇽', followers: '5.5k',  roi: '+87%',  winRate: '64%', trades: 278, drawdown: '11.3%', monthly: '+7.3%',  color: '#10b981' },
  { name: 'Sofia L.',       initials: 'SL', country: '🇩🇪', followers: '4.9k',  roi: '+76%',  winRate: '68%', trades: 133, drawdown: '7.8%',  monthly: '+6.3%',  color: '#f59e0b' },
  { name: 'Kwame Acheampong', initials: 'KA', country: '🇬🇭', followers: '4.1k', roi: '+64%', winRate: '62%', trades: 198, drawdown: '9.5%', monthly: '+5.3%',  color: '#3b82f6' },
  { name: 'Emma Wilson',    initials: 'EW', country: '🇬🇧', followers: '3.7k',  roi: '+58%',  winRate: '67%', trades: 97,  drawdown: '4.9%',  monthly: '+4.8%',  color: '#ef4444' },
  { name: 'Jin Park',       initials: 'JP', country: '🇰🇷', followers: '3.2k',  roi: '+51%',  winRate: '65%', trades: 172, drawdown: '6.2%',  monthly: '+4.3%',  color: '#84cc16' },
];
      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <div>
            ...
            <p className={styles.subtitle}>Automatically replicate top trader strategies in your account</p>
          </div>
        </div>
          ...
          <div key={t.name} className={styles.card}>
            ...
            <div className={styles.cardStats}>
              <div className={styles.cardStat}>
                <span className={styles.cardStatVal} style={{ color: '#16a34a' }}>{t.winRate}</span>
              ...
              <div className={styles.cardStat}>
                <span className={styles.cardStatVal} style={{ color: '#dc2626' }}>{t.drawdown}</span>
                <span className={styles.cardStatLbl}>Max DD</span>
              </div>
              <div className={styles.cardStat}>
                <span className={styles.cardStatVal} style={{ color: '#16a34a' }}>{t.monthly}</span>
