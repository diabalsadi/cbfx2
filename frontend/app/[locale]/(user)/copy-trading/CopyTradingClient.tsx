    ...
    <div className={styles.page}>
      ...
      <div className={styles.statsBar}>
        ...
        <div className={styles.statItem}>
          ...
          <span className={styles.statLbl}>{t("stats.avgRoi")}</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.statItem}>
          <span className={styles.statVal}>120k+</span>
          <span className={styles.statLbl}>{t("stats.activeCopiers")}</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.statItem}>
      ...
      <div className={styles.grid}>
        {filtered.map((trader) => (
          <div key={trader.name} className={styles.card}>
            {/* Card top */}
            <div className={styles.cardTop}>
              <div className={styles.avatar} style={{ background: trader.color }}>
                {trader.initials}
              </div>
              <div className={styles.traderInfo}>
                <div className={styles.traderName}>
                  {trader.name} <span className={styles.flag}>{trader.country}</span>
                </div>
                <div className={styles.traderFollowers}>
                  {trader.followers} {t("followers")}
                </div>
              </div>
              <div className={styles.roiBadge}>{trader.roi}</div>
            </div>
            ...
            <div className={styles.cardStats}>
              ...
              <div className={styles.cardStat}>
                <span className={styles.cardStatVal}>{trader.trades}</span>
                <span className={styles.cardStatLbl}>{t("trades")}</span>
              </div>
              <div className={styles.cardStat}>
                <span
                  className={styles.cardStatVal}
              ...
              <div className={styles.cardStat}>
                ...
                <span className={styles.cardStatLbl}>{t("monthly")}</span>
              </div>
            </div>

            {/* Mini ROI chart (SVG sparkline) */}
            <div className={styles.sparklineWrap}>
              <Sparkline color={trader.color} />
            </div>
