...
export async function generateMetadata({
  ...
  const seo = await getSeoMeta("analysis_detail", locale, { title: article?.title ?? "Technical Analysis" });
  ...
  return await buildMetadata(seo, locale, { alternates: localizedAlternates(`/analysis/${id}`, locale) });
}
