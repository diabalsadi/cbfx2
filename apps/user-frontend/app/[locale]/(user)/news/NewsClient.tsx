...
import { MarketNewsWidget } from "@/components/TradingViewWidgets";
  ...
  return (
    <>
      ...
      <div className={styles.pageGrid}>
        ...
        {/* Live third-party newswire, supplementing our own articles */}
        <aside className={styles.sideCol}>
          <div className={styles.panel}>
            <h2 className={styles.panelTitle}>{t("marketNewsTitle")}</h2>
