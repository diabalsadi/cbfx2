...
export async function generateMetadata({
  ...
  const seo = await getSeoMeta("forum_detail", locale, { title: thread?.title ?? "Discussion" });
  return await buildMetadata(seo, locale, { alternates: localizedAlternates(`/forum/${id}`, locale) });
}
