# ISO 3166-1 alpha-2 codes for broker "country" coverage mode. Kept separate from
# backend_shared.utils.geo's regional buckets (used for IP -> region detection), since a
# broker's country coverage list should be able to include any country in the
# world, not just the ones bucketed into the six geo_coverage regions.
COUNTRIES = [
...
COUNTRY_LABELS = {code: name for code, name in COUNTRIES}
